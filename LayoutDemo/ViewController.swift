...
//        test_out_size()
    ...
    private func test_out_inset() {
        contentLabel.remake.in.edges(top: 200, left: 100, bottom: 200, right: 100, topBottomRelativeToMargin: true).to(self.view)
...
//        label1.remake.out.top(inset: inset).left(inset: inset, rightInset: inset, height: height).to(contentLabel)
//        label1.remake.out.left(inset: inset).top(inset: inset, bottomInset: inset, width: width).to(contentLabel)

//        label2.remake.out.top(inset: inset).centerX(min_leftRightInset: inset, height: height).to(contentLabel)

        label3.remake.out.top(inset).right(inset, leftInset: inset, height: height).to(contentLabel)
//        label3.remake.out.right(inset: inset).top(inset: inset, bottomInset: inset, width: width).to(contentLabel)
...
//        label7.remake.out.left(inset: inset).bottom(inset: inset, topInset: inset, width: width).to(contentLabel)

//        label8.remake.out.bottom(inset: inset).centerX(min_leftRightInset: inset, height: height).to(contentLabel)

//        label9.remake.out.bottom(inset: inset).right(inset: inset, leftInset: inset, height: height).to(contentLabel)
//        label9.remake.out.right(inset: inset).bottom(inset: inset, topInset: inset, width: width).to(contentLabel)
...
//        label4.remake.out.right(inset: inset).top(inset: inset, width: width, height: height).to(contentLabel)
//        label5.remake.out.right(inset: inset).centerY(offset: inset, width: width, height: height).to(contentLabel)
//        label6.remake.out.right(inset: inset).bottom(inset: inset, width: width, height: height).to(contentLabel)
//
    ...
    private func test_in_inset() {
        contentLabel.remake.in.edges(top: 20, left: 20, bottom: 20, right: 20, topBottomRelativeToMargin: true).to(self.view)
        let inset: CGFloat? = 20
...
//        label1.remake.in.left(inset: inset).top(inset: inset, bottomInset: inset, width: width).to(contentLabel)
...
//        label3.remake.in.right(inset: inset).top(inset: inset, bottomInset: inset, width: width).to(contentLabel)
...
//        label7.remake.in.left(inset: inset).bottom(inset: inset, topInset: inset, width: width).to(contentLabel)
...
//        label9.remake.in.right(inset: inset).bottom(inset: inset, topInset: inset, width: width).to(contentLabel)
    }
